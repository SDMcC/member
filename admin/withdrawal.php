<?php
    ...
    */
    ...
    $egWithdrawal = new egWithdrawal();

    if(isset($_REQUEST['do'])) {
        if(file_exists($phpfile = _EG_ADMIN_MODULES_DIR. 'withdrawal/' . safe_string($_REQUEST['do']) . '.php')) {
    ...
    require_once (_EG_ADMIN_MODULES_DIR . 'withdrawal/'.'chart.php');
    exit(); 
