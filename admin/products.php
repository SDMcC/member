<?php
    ...
    */
    ...
    if(!egFeatures::feature_enabled('product')) egAdmin::admin_error(_error_features_inactive);
    $egLanguage->include_admin_translation(__FILE__);

    if(isset($_REQUEST['do'])) {
        if(file_exists($phpfile = _EG_ADMIN_MODULES_DIR. 'products/' . safe_string($_REQUEST['do']) . '.php')) {
    ...
    require_once (_EG_ADMIN_MODULES_DIR . 'products/'.'chart.php');
    exit(); 
