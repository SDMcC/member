<?php
    ...
    */
    ...
    $egPayment = new egPayment();

    if(isset($_REQUEST['do'])) {
        if(file_exists($phpfile = _EG_ADMIN_MODULES_DIR. 'payment/' . safe_string($_REQUEST['do']) . '.php')) {
    ...
    require_once (_EG_ADMIN_MODULES_DIR . 'payment/'.'chart.php');
    exit(); 
