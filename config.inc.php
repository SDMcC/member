<?php
    ...
    * Copyright 2023 Elwin HG - http://egnsoftware.com (elwin@cvegn.com)
    * ---------------------------------------------------------------------------
    ...
    * ---------------------------------------------------------------------------
    */
    define('DOCSPATH', dirname(__FILE__) . '/');
    define('EG_LOGERROR', 1);
    define('EG_MINIFY_OUTPUT', 0);
    define('EG_CLEAN_URL', 0);
    define('EG_LOGWARNING', 0);
